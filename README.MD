...
Only by [one line code](#Step 3),and all TextView、Button、ImageView and [others support view](#Support View) will show text border、color attr in top of View like gif demo.
