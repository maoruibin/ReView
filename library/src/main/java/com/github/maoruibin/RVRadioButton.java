...
class RVRadioButton extends RadioButton implements IReviewView {

    private IReviewControl developViewImpl = new UIDisplayFrameAndInfoImpl(this);

    public RVRadioButton(Context context) {
        super(context);
        init(context);
    }

    public RVRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RVRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
