...
class RVCheckBox extends CheckBox implements IReviewView {

    private IReviewControl developViewImpl = new UIDisplayFrameAndInfoImpl(this);

    public RVCheckBox(Context context) {
        super(context);
        init(context);
    }

    public RVCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RVCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
